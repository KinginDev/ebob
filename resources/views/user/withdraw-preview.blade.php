                    ...
                    <div class="panel panel-primary panel-custom">
                        ...
                        <div class="panel-body">
                            <div class="text-center">
                                <h3 class="bold uppercase">Current Balance : <strong>{{number_format( $balance->balance, $basic->decimal) }}
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label style="margin-top: 5px;font-size: 14px;"
                                           class="col-sm-4 col-sm-offset-1 bold uppercase text-right control-label">Request
                                        Amount : </label>
