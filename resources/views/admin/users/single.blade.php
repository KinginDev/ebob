    ...
    <div class="row">
            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <h5 class="bold">Balance
                        : {{number_format(floatval($user->balance), $basic->decimal, '.', '')}} {{$basic->currency}}</h5>
                    <hr>
                    <p>
        ...
        <div class="col-md-9">
            @php
                ...
                $withDrawAmount = \App\WithdrawLog::whereUser_id($user->id)->whereStatus(1)->sum('amount');
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4">
                    <a href="{{route('user.withdraw',$user->id)}}" class="text-decoration">
